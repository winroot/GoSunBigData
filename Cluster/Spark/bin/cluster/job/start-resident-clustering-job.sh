...
SERVICE_LIB_DIR=${DEPLOY_DIR}/service/clustering/lib
## bigdata_env
...
if [ ! -e ${SERVICE_CONF_DIR}/common_service_es.properties ];then
    ...
    echo "copy 文件 common_service_es.properties 到 spark/conf......"  | tee  -a  $LOG_FILE
    cp ${SERVICE_CONF_DIR}/common_service_es.properties ${SPARK_CONF_PATH}
