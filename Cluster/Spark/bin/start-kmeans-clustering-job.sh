...
${SPARK_LIB_DIR}/common-clustering-2.3.0.jar,\
${SPARK_LIB_DIR}/common-es-2.3.0.jar,\
...
${SPARK_LIB_DIR}/lucene-analyzers-common-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-backward-codecs-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-core-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-grouping-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-memory-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-misc-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-queries-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-queryparser-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-sandbox-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-spatial3d-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-spatial-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-spatial-extras-6.6.0.jar,\
${SPARK_LIB_DIR}/lucene-suggest-6.6.0.jar,\
