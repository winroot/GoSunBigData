...
public class FaceAttribute implements Serializable{
     ...
     * 是否带帽子
     */
    @ApiModelProperty(value = "是否带帽子")
    private int hat;

    /**
     * 是否系领带
     */
    @ApiModelProperty(value = "是否系领带")
    private int tie;

    /**
     * 胡子类型
     */
    @ApiModelProperty(value = "胡子类型")
    private int huzi;

    /**
     * 是否戴眼镜
     */
    @ApiModelProperty(value = "是否带眼镜")
    private int eyeglasses;

    /**
     * 清晰度评价,清晰为0，不清晰为1
     */
    @ApiModelProperty(value = "清晰度评价")
