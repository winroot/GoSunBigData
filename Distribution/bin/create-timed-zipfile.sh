...
function create_zip()
{
    ...
    [nN][uU][lL][lL] )
        ...
        echo "CLUSTER_BIN_DIR=/opt/GoSunBigData/RealTimeCompare/spark/bin" >> ${SCHEMA_MERGE_MID_TABLE_JOB}
    ...
    [nN][oO][wW] )
        ...
        echo "CLUSTER_BIN_DIR=/opt/GoSunBigData/RealTimeCompare/spark/bin" >> ${SCHEMA_MERGE_PERSON_TABLE_JOB}
    ...
    [bB][eE][fF][oO][rR][eE] )
        ...
        echo "CLUSTER_BIN_DIR=/opt/GoSunBigData/RealTimeCompare/spark/bin person_table before" >> ${SCHEMA_MERGE_PERSON_TABLE_BEFORE_JOB}
    ...
    [oO][fF][fF][lL][iI][nN][eE] )
        ...
        echo "CLUSTER_BIN_DIR=/opt/GoSunBigData/RealTimeCompare/spark/bin" >> ${START_FACE_OFFLINE_ALARM_JOB}
